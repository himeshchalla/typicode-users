...
define('WP_TESTS_CONFIG_FILE_PATH', "/var/www/html/test/wordpress_test/inpsyde_test/test/wp-content/plugins/plugintestslughere/tests/wordpress-develop/wp-tests-config.php");
...
echo "\n";
var_dump(!is_readable( $config_file_path ));
echo "\n";
var_dump(defined( 'WP_TESTS_CONFIG_FILE_PATH' ));
